...
private:
	...
	uint32_t screen_update_sealy(screen_device &screen, bitmap_argb32 &bitmap, const rectangle &cliprect);
...
uint32_t sealy_state::screen_update_sealy(screen_device &screen, bitmap_argb32 &bitmap, const rectangle &cliprect)
{
