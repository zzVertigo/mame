...
public:
	...
	typedef void (galaxian_state::*galaxian_draw_bullet_func)(bitmap_argb32 &bitmap, const rectangle &cliprect, int offs, int x, int y);
	typedef void (galaxian_state::*galaxian_draw_background_func)(bitmap_argb32 &bitmap, const rectangle &cliprect);
	...
	uint32_t screen_update_galaxian(screen_device &screen, bitmap_argb32 &bitmap, const rectangle &cliprect);
	...
	void sprites_draw(bitmap_argb32 &bitmap, const rectangle &cliprect, const uint8_t *spritebase);
	void bullets_draw(bitmap_argb32 &bitmap, const rectangle &cliprect, const uint8_t *base);
	void stars_init();
	void stars_update_origin();
	void stars_draw_row(bitmap_argb32 &bitmap, int maxx, int y, uint32_t star_offs, uint8_t starmask);
	void null_draw_background(bitmap_argb32 &bitmap, const rectangle &cliprect);
	void galaxian_draw_background(bitmap_argb32 &bitmap, const rectangle &cliprect);
	void background_draw_colorsplit(bitmap_argb32 &bitmap, const rectangle &cliprect, rgb_t color, int split, int split_flipped);
	...
	void anteater_draw_background(bitmap_argb32 &bitmap, const rectangle &cliprect);
	void jumpbug_draw_background(bitmap_argb32 &bitmap, const rectangle &cliprect);
	void turtles_draw_background(bitmap_argb32 &bitmap, const rectangle &cliprect);
	void sfx_draw_background(bitmap_argb32 &bitmap, const rectangle &cliprect);
	void frogger_draw_background(bitmap_argb32 &bitmap, const rectangle &cliprect);
	inline void galaxian_draw_pixel(bitmap_argb32 &bitmap, const rectangle &cliprect, int y, int x, rgb_t color);
	void galaxian_draw_bullet(bitmap_argb32 &bitmap, const rectangle &cliprect, int offs, int x, int y);
	void mshuttle_draw_bullet(bitmap_argb32 &bitmap, const rectangle &cliprect, int offs, int x, int y);
	void scramble_draw_bullet(bitmap_argb32 &bitmap, const rectangle &cliprect, int offs, int x, int y);
	void theend_draw_bullet(bitmap_argb32 &bitmap, const rectangle &cliprect, int offs, int x, int y);
