...
public:
	...
	uint32_t screen_update_goldstar(screen_device &screen, bitmap_argb32 &bitmap, const rectangle &cliprect);
	uint32_t screen_update_cmast91(screen_device &screen, bitmap_argb32 &bitmap, const rectangle &cliprect);
...
public:
	...
	uint32_t screen_update_amcoe1a(screen_device &screen, bitmap_argb32 &bitmap, const rectangle &cliprect);
...
public:
	...
	uint32_t screen_update_bingowng(screen_device &screen, bitmap_argb32 &bitmap, const rectangle &cliprect);
	uint32_t screen_update_magical(screen_device &screen, bitmap_argb32 &bitmap, const rectangle &cliprect);
	uint32_t screen_update_mbstar(screen_device &screen, bitmap_argb32 &bitmap, const rectangle &cliprect);
...
public:
	...
	uint32_t screen_update_sangho(screen_device &screen, bitmap_argb32 &bitmap, const rectangle &cliprect);
...
public:
	...
	uint32_t screen_update_unkch(screen_device &screen, bitmap_argb32 &bitmap, const rectangle &cliprect);
