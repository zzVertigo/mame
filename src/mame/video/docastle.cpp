...
void docastle_state::draw_sprites( screen_device &screen, bitmap_argb32 &bitmap, const rectangle &cliprect )
{
	int offs;
...
uint32_t docastle_state::screen_update_docastle(screen_device &screen, bitmap_argb32 &bitmap, const rectangle &cliprect)
{
