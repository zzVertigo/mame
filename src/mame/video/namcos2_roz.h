...
private:
	...
	void zdrawgfxzoom(screen_device &screen, bitmap_argb32 &dest_bmp, const rectangle &clip, gfx_element *gfx, uint32_t code, uint32_t color, int flipx, int flipy, int sx, int sy, int scalex, int scaley, int zpos);
