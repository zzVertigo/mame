...
inline void deco_zoomspr_device::dragngun_drawgfxzoom(
		...
		bitmap_ind8 &pri_bitmap, bitmap_argb32 &temp_bitmap,
		int priority)
{
	rectangle myclip;
...
void deco_zoomspr_device::dragngun_draw_sprites( bitmap_argb32 &bitmap, const rectangle &cliprect, const uint32_t *spritedata, uint32_t* dragngun_sprite_layout_0_ram, uint32_t* dragngun_sprite_layout_1_ram, uint32_t* dragngun_sprite_lookup_0_ram, uint32_t* dragngun_sprite_lookup_1_ram, uint32_t dragngun_sprite_ctrl,  bitmap_ind8 &pri_bitmap, bitmap_argb32 &temp_bitmap)
{
